...
export function Footer() {
  return (
    <footer className="bg-tc-navy-dark text-stone-200/70">
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-10">
        <div className="flex flex-col items-start justify-between gap-8 border-b border-white/10 pb-10 sm:flex-row sm:items-center">
          <div className="flex items-center gap-3 text-stone-50">
            <HouseMark className="h-6 w-6 text-tc-powder" />
            <span className="font-tc-display text-lg italic tracking-wide">
              Tiemann &amp; Co.
            </span>
          </div>
          <nav className="flex flex-wrap gap-x-8 gap-y-2 text-sm">
            ...
            <a href="#objekte" className="hover:text-stone-50">
              Objekte
            </a>
        ...
        <div className="flex flex-col gap-4 pt-8 text-xs sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="flex gap-6">
            <a href="/impressum" className="hover:text-stone-50">
              Impressum
            </a>
            <a href="/datenschutz" className="hover:text-stone-50">
              Datenschutz
            </a>
          </div>
        </div>
