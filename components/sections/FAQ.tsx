...
const HOMEPAGE_FAQS: FAQItem[] = [
    ...
    },
    {
        ...
        a: "Mein Ansatz basiert auf systematischer Analyse und datengetriebener Umsetzung. Im ersten Schritt prüfe ich, wie KI-Systeme dein Unternehmen aktuell beschreiben, etwa in ChatGPT, Perplexity, Google AI Overviews und Copilot. Ich stelle die Fragen, die deine potenziellen Kunden stellen, und dokumentiere, ob und wie du genannt wirst. Dann identifiziere ich die konkreten Lücken und setze priorisierte Maßnahmen um: Schema.org Markup, Content-Überarbeitung für maximale Zitierbarkeit, Seitenarchitektur-Optimierung und systematischen Aufbau externer Autoritätssignale. Fortschritte messe ich kontinuierlich und passe die Strategie an."
    }
];
