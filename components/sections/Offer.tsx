                ...
                <div className="relative z-10 grid lg:grid-cols-2 gap-24 items-start">
                    <div>
                        ...
                        <p className="text-xl text-gray-400 mb-12 leading-tight max-w-lg font-medium">
                            Ein kurzer Call. Wir schauen live nach, <strong className="text-white">wo du stehst</strong>, und du weißt danach, ob sich das Thema für dich lohnt.
                        </p>
                        ...
                        <div className="text-sm text-gray-500 font-medium space-y-2 mb-16">
                            <span className="block italic">Format: 15 Minuten Videocall oder Telefon.</span>
                            <span className="block italic">Kein schriftlicher Report, keine Verpflichtung.</span>
                        </div>
                    ...
                    <div className="bg-white p-12 md:p-16 rounded-card shadow-2xl text-center flex flex-col items-center sticky top-32">
                        <h3 className="text-2xl font-semibold mb-4 text-black tracking-tight">Termin buchen</h3>
                        <p className="text-gray-500 text-base mb-10 font-medium">Finde heraus, ob du in KI-Antworten stattfindest.</p>
                        <Link href="/termin">
                            <Button text="15 Minuten buchen" primary={true} className="w-full justify-center py-5 text-lg" />
                        </Link>
