...
export const metadata: Metadata = {
  ...
  description:
    "AI SEO Agentur aus Hamburg für Generative Engine Optimization (GEO). Direkt mit dem Gründer, datengetrieben, messbar in ChatGPT, Perplexity, Claude, Gemini und Google AI.",
