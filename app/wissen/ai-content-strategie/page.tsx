...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Nein, im Gegenteil. Die meisten KI-Content-Prinzipien - klare Struktur, Answer-First, Quellenangaben, regelmäßige Updates - verbessern auch dein Google-Ranking. Google AI Overviews nutzen ähnliche Signale wie die organische Suche. Du optimierst also für zwei Kanäle gleichzeitig.',
  },
];
  ...
  return (
    <div className="relative w-full overflow-hidden bg-[#F7F5F2] text-brand-text font-sans selection:bg-brand-accent selection:text-white">
      ...
      <section className="px-6 md:px-12 lg:px-20 max-w-[900px] mx-auto pb-12">
            ...
            <ul className="space-y-3 text-gray-700 leading-relaxed">
              ...
              <li className="flex items-start gap-2">
                ...
                <span><strong className="text-black">Answer-First ist Pflicht.</strong> KI-Systeme bevorzugen Inhalte, die die Antwort sofort liefern - nicht nach 500 Wörtern Einleitung.</span>
              </li>
              <li className="flex items-start gap-2">
              ...
              <li className="flex items-start gap-2">
                ...
                <span><strong className="text-black">3 Content-Typen dominieren:</strong> Definitorisch ("Was ist X?"), Vergleich ("X vs Y"), How-To (Schritt-für-Schritt).</span>
              </li>
              <li className="flex items-start gap-2">
                <span className="text-brand-accent font-bold mt-0.5">5.</span>
                <span><strong className="text-black">Content ohne Quellen ist für KI wertlos.</strong> Zahlen, Studien und verifizierbare Fakten machen deinen Content zitierbar.</span>
              </li>
            </ul>
          </div>
      </section>
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20 max-w-[900px] mx-auto border-t border-gray-100">
            ...
            Warum deine Content-Strategie für KI-Systeme nicht funktioniert
          </h2>
          ...
          <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
            ...
            <p>
              Das Problem: Keyword-optimierter Content &#8800; zitierbarer Content. Google bewertet Relevanz anhand von Keywords, Backlinks und Nutzerverhalten. KI-Systeme bewerten, ob sie eine Aussage <strong className="text-black">sicher weiterempfehlen</strong> können. Das erfordert andere Strukturen, andere Formate, andere Inhalte.
            </p>
          </div>
          ...
          <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
            ...
            <p>
              <strong className="text-black">Content ohne Struktur ist für KI unsichtbar.</strong> Lange Fließtexte ohne klare Hierarchie, ohne Fakten, ohne Quellen - das ist für einen LLM nicht verwertbar. KI braucht extrahierbare, verifizierbare Informationsbausteine.
            </p>
          </div>
      </section>
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="bg-white border border-gray-100 rounded-2xl p-6">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Die Antwort steht sofort im ersten Absatz. Kontext und Details folgen danach. KI extrahiert bevorzugt die ersten 2-3 Sätze eines Abschnitts. Wer die Antwort erst nach 500 Wörtern Einleitung liefert, wird übersprungen.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Zahlen, Studien, Quellen. KI-Systeme können Aussagen mit Belegen sicherer weiterempfehlen als Meinungen ohne Grundlage. "Unserer Erfahrung nach" ist schwächer als "Laut Princeton-Studie (2024)".
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Klare H2/H3-Hierarchie, Listen, Tabellen. KI-Systeme parsen Inhalte anhand ihrer Struktur. Ein langer Fließtext ohne Zwischenüberschriften ist für LLMs schwer zu verarbeiten und wird seltener zitiert.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Keine Mehrdeutigkeit, klare Aussagen. "Es kommt darauf an" ist keine Antwort, die KI zitieren kann. Konkrete Empfehlungen mit Kontext ("Für Unternehmen mit unter 50 Mitarbeitern empfehlen wir X") sind zitierbarer.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6 sm:col-span-2">
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Datum sichtbar, regelmäßige Updates. KI-Systeme bevorzugen aktuelle Inhalte - insbesondere Perplexity und Google AI Overviews, die das Live-Web durchsuchen. Ein Artikel von 2022 ohne Update-Datum wird gegenüber einem aktuellen Beitrag benachteiligt. Zeige dein Aktualisierungsdatum prominent.
              </p>
            </div>
          </div>
      </section>
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20 max-w-[900px] mx-auto border-t border-gray-100">
          ...
          <p className="text-lg text-gray-600 leading-relaxed mb-10">
            Nicht jeder Content-Typ wird gleich häufig von KI zitiert. Diese drei Formate dominieren in KI-Antworten.
          </p>
          ...
          <ol className="space-y-10">
            ...
            <li>
              <div className="bg-white border border-gray-100 rounded-2xl p-6 md:p-8">
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-4">
                  Wird für Erklärungen zitiert. Wenn jemand ChatGPT fragt "Was ist Generative Engine Optimization?", sucht die KI nach klaren, prägnanten Definitionen mit Kontext.
                </p>
                <div className="bg-gray-50 rounded-xl p-5">
                  <p className="text-sm font-semibold text-black mb-2">Vorlage:</p>
                  <p className="text-sm text-gray-600 leading-relaxed italic">
                    "[Begriff] ist [klare Definition in 1-2 Sätzen]. Im Unterschied zu [Abgrenzung] fokussiert sich [Begriff] auf [Kernaspekt]. Für Unternehmen bedeutet das: [praktische Relevanz]."
                  </p>
                </div>
              </div>
            </li>
            ...
            <li>
              <div className="bg-white border border-gray-100 rounded-2xl p-6 md:p-8">
                ...
                <p className="text-lg text-gray-600 leading-relaxed mb-4">
                  Wird für Empfehlungen genutzt. KI-Nutzer fragen "Was ist besser, X oder Y?" oder "Welches Tool für Z?". Ehrliche, strukturierte Vergleiche werden bevorzugt zitiert.
                </p>
                <div className="bg-gray-50 rounded-xl p-5">
                  <p className="text-sm font-semibold text-black mb-2">Vorlage:</p>
                  <p className="text-sm text-gray-600 leading-relaxed italic">
                    "[X] eignet sich am besten für [Zielgruppe/Anwendungsfall]. [Y] ist die bessere Wahl, wenn [Bedingung]. Der wichtigste Unterschied: [Kernunterschied mit Fakten]."
                  </p>
                </div>
              </div>
            </li>
            ...
            <li>
              <div className="bg-white border border-gray-100 rounded-2xl p-6 md:p-8">
                <h3 className="text-xl md:text-2xl font-semibold text-black mb-4">
                  3. How-To Content - Schritt-für-Schritt
                </h3>
                <p className="text-lg text-gray-600 leading-relaxed mb-4">
                  Wird für Anleitungen zitiert. Wenn Nutzer KI nach konkreten Anleitungen fragen, extrahiert die KI nummerierte Schritte aus strukturierten Guides.
                </p>
                <div className="bg-gray-50 rounded-xl p-5">
                  <p className="text-sm font-semibold text-black mb-2">Vorlage:</p>
                  <p className="text-sm text-gray-600 leading-relaxed italic">
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20 max-w-[900px] mx-auto border-t border-gray-100">
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-6 md:p-8">
            ...
            <ul className="space-y-4 text-gray-600 leading-relaxed">
              <CheckItem text="Answer-First: Die Kernantwort steht in den ersten 2-3 Sätzen jedes Abschnitts" />
              <CheckItem text="Klare H2/H3-Hierarchie: Jeder Abschnitt hat eine beschreibende Zwischenüberschrift" />
              <CheckItem text="Quellenangaben: Statistiken und Aussagen sind mit Studien oder Quellen belegt" />
              <CheckItem text="Aktualität: Veröffentlichungs- und Aktualisierungsdatum sind sichtbar" />
              ...
              <CheckItem text="Entitäten abgedeckt: Relevante Begriffe, Personen und Konzepte sind erwähnt und verknüpft" />
              <CheckItem text="Interne Verlinkung: Der Artikel ist Teil eines Topic Clusters mit verwandten Inhalten" />
              <CheckItem text="Kein Keyword-Stuffing: Der Text liest sich natürlich und informativ" />
              ...
              <CheckItem text="Meta-Beschreibung: Fasst den Inhalt in 1-2 Sätzen präzise zusammen" />
            </ul>
      ...
      {/* ============================================================ */}
      {/*  7 Strategien für KI-optimierten Content                    */}
      {/* ============================================================ */}
      <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20 max-w-[900px] mx-auto border-t border-gray-100">
                  <h2 className="text-3xl md:text-4xl font-semibold tracking-[-0.03em] text-black mb-4">
            7 Strategien für KI-optimierten Content
          ...
          <ol className="space-y-10">
            <li>
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-3">
                Jeder Abschnitt beginnt mit der Kernantwort. Nicht mit einer Einleitung, nicht mit Kontext, nicht mit einer rhetorischen Frage. <strong className="text-black">Die Antwort zuerst, die Erklärung danach.</strong>
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Warum? KI-Systeme extrahieren bevorzugt die ersten Sätze eines Abschnitts. Wenn deine Antwort erst im dritten Absatz kommt, wird sie möglicherweise nicht erfasst. Journalisten nennen das "Inverted Pyramid" - und es ist das effektivste Format für KI-Zitierungen.
              </p>
            </li>
            ...
            <li>
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-3">
                Einzelne Artikel sind schwächer als vernetzte Content-Cluster. Ein Pillar-Artikel zum Hauptthema, verlinkt mit 5-10 spezifischen Unterartikeln, signalisiert KI-Systemen: <strong className="text-black">Diese Quelle hat umfassende Expertise.</strong>
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Beispiel: Statt eines einzelnen Artikels "KI-Sichtbarkeit" erstellst du einen Pillar-Guide plus Unter-Guides zu ChatGPT, Perplexity, technischer Umsetzung, Content-Strategie und Messung. KI erkennt die thematische Tiefe und zitiert häufiger.
              </p>
            </li>
            ...
            <li>
              ...
              <p className="text-lg text-gray-600 leading-relaxed mb-3">
                KI-Systeme bevorzugen verifizierbare Aussagen. <strong className="text-black">"Laut Gartner (2024) verlieren Marken bis 2028 über 50% ihres organischen Traffics"</strong> ist zitierbarer als "Der Traffic wird sinken".
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Baue in jeden Artikel mindestens 3-5 Quellenverweise ein. Nenne die Quelle, das Jahr und die Kernaussage. Verlinke, wenn möglich. Das erhöht nicht nur die KI-Zitierbarkeit, sondern auch die E-E-A-T-Signale für Google.
              </p>
            </li>

            <li>
              <h3 className="text-xl md:text-2xl font-semibold text-black mb-3">
                4. FAQ-Sektionen für jede Seite
              </h3>
              <p className="text-lg text-gray-600 leading-relaxed mb-3">
                FAQ-Bereiche sind Gold für KI-Zitierungen. Warum? Sie liefern exakt das Format, das KI braucht: <strong className="text-black">eine klare Frage und eine präzise Antwort.</strong>
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Ergänze jede wichtige Seite um 5-7 relevante Fragen mit ausführlichen Antworten (3-5 Sätze). Implementiere FAQPage-Schema-Markup. Die Fragen sollten echte Nutzerfragen sein - nicht Marketing-Fragen wie "Warum sind wir die Besten?"
              </p>
            </li>

            <li>
              <h3 className="text-xl md:text-2xl font-semibold text-black mb-3">
                5. Regelmäßige Content-Aktualisierung
              </h3>
              <p className="text-lg text-gray-600 leading-relaxed mb-3">
                <strong className="text-black">Veralteter Content wird von KI bestraft.</strong> Perplexity und Google AI Overviews bevorzugen aktuelle Quellen. Auch LLMs wie ChatGPT gewichten in neueren Trainingsläufen aktuellere Inhalte höher.
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Plane quartalmäßige Reviews deiner Top-Inhalte. Aktualisiere Statistiken, ergänze neue Erkenntnisse, entferne veraltete Informationen. Zeige das Aktualisierungsdatum prominent auf der Seite.
              </p>
            </li>

            <li>
              <h3 className="text-xl md:text-2xl font-semibold text-black mb-3">
                6. Semantische Vollständigkeit - Entitäten abdecken
              </h3>
              <p className="text-lg text-gray-600 leading-relaxed mb-3">
                KI-Systeme arbeiten mit Entitäten (Personen, Konzepte, Orte, Tools). <strong className="text-black">Wenn dein Artikel ein Thema behandelt, aber wichtige verwandte Entitäten fehlen, wirkt er für KI unvollständig.</strong>
              </p>
              <p className="text-lg text-gray-600 leading-relaxed">
                Beispiel: Ein Artikel über "KI-Sichtbarkeit" ohne Erwähnung von ChatGPT, Perplexity, Schema.org oder E-E-A-T ist semantisch unvollständig. Recherchiere, welche Entitäten KI mit deinem Thema verknüpft, und decke sie in deinem Content ab.
              </p>
            </li>
            ...
            <li>
              ...
              <p className="text-lg text-gray-600 leading-relaxed">
                Eigene Daten, eigene Erfahrungsberichte, eigene Frameworks, eigene Case Studies. "Wir haben 50 Websites analysiert und festgestellt..." ist zitierbarer als eine Zusammenfassung von dem, was alle anderen auch schreiben. Originalität ist der stärkste Zitierungstreiber.
              </p>
            </li>
          </ol>
      </section>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="border-b-2 border-gray-200">
                  ...
                  <th className="py-3 text-sm font-semibold text-black">Stärke</th>
                </tr>
              </thead>
              <tbody className="text-sm text-gray-600">
                ...
                <tr className="border-b border-gray-100">
                  ...
                  <td className="py-3 pr-4 text-brand-accent font-semibold">Sehr hoch</td>
                  <td className="py-3">Perfektes Frage-Antwort-Format für KI-Extraktion</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="py-3 pr-4 font-medium text-black">Glossar-Eintrag</td>
                  <td className="py-3 pr-4 text-brand-accent font-semibold">Sehr hoch</td>
                  <td className="py-3">Klare Definitionen, ideal für "Was ist X?"-Anfragen</td>
                </tr>
                <tr className="border-b border-gray-100">
                ...
                <tr className="border-b border-gray-100">
                  ...
                  <td className="py-3">Abhängig von Struktur und Quellenqualität</td>
                </tr>
                <tr className="border-b border-gray-100">
                  <td className="py-3 pr-4 font-medium text-black">Video-Transkript</td>
                  <td className="py-3 pr-4 font-semibold">Niedrig-Mittel</td>
                  <td className="py-3">Nur wenn sauber strukturiert und als Text verfügbar</td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20 max-w-[900px] mx-auto border-t border-gray-100">
          ...
          <ol className="space-y-8">
            <li>
              <div className="bg-white border border-gray-100 rounded-2xl p-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Frag ChatGPT, Perplexity und Google AI direkt nach deinem Thema. Welche Fragen stellen Nutzer? Welche Quellen werden aktuell zitiert? Welche Lücken gibt es? Nutze auch Tools wie AlsoAsked, AnswerThePublic und die Google-Autovervollständigung für Frage-Recherche.
                </p>
              </div>
            </li>
            ...
            <li>
              <div className="bg-white border border-gray-100 rounded-2xl p-6">
                <h3 className="text-xl font-semibold text-black mb-3">
                  Schritt 2: Entitäten und Struktur planen
                </h3>
                <p className="text-gray-600 leading-relaxed">
                  Definiere die Kernaussage (Answer-First), die H2/H3-Struktur und die relevanten Entitäten. Welche Begriffe, Tools, Studien und Experten müssen vorkommen? Erstelle ein Outline mit allen Elementen, bevor du schreibst.
                </p>
              </div>
            </li>
            ...
            <li>
              <div className="bg-white border border-gray-100 rounded-2xl p-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Schreibe jeden Abschnitt mit der Antwort zuerst. Baue Statistiken und Quellenverweise ein. Nutze Listen und Tabellen für komplexe Informationen. Halte Absätze kurz (3-5 Sätze) und eindeutig.
                </p>
              </div>
            </li>
            ...
            <li>
              <div className="bg-white border border-gray-100 rounded-2xl p-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Implementiere Schema-Markup (Article, FAQ, HowTo). Prüfe die H-Tag-Hierarchie. Ergänze eine FAQ-Sektion. Setze interne Links zu verwandten Inhalten im Topic Cluster. Stelle sicher, dass Datum und Autor sichtbar sind.
                </p>
              </div>
            </li>
            ...
            <li>
              <div className="bg-white border border-gray-100 rounded-2xl p-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Prüfe nach 4-8 Wochen, ob dein Content in Perplexity-Antworten auftaucht. Teste relevante Fragen in ChatGPT und Google AI. Tracke KI-Referral-Traffic in GA4. Aktualisiere und verbessere basierend auf den Ergebnissen.
                </p>
              </div>
            </li>
          </ol>
      ...
      {/* ============================================================ */}
      {/*  Typische Content-Fehler für KI                             */}
      {/* ============================================================ */}
      <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20 max-w-[900px] mx-auto border-t border-gray-100">
                  <h2 className="text-3xl md:text-4xl font-semibold tracking-[-0.03em] text-black mb-8">
            Typische Content-Fehler für KI
          ...
          <div className="space-y-6">
            <div className="bg-white border border-gray-100 rounded-2xl p-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Lange Einleitungen, Füllwörter, Marketing-Floskeln. KI-Systeme suchen nach konkreten Aussagen und Fakten. "In der heutigen digitalen Welt..." ist für einen LLM wertlos. Komm direkt zum Punkt.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Aussagen ohne Belege sind für KI schwer zu verifizieren und werden seltener zitiert. "Studien zeigen" ohne konkrete Studie ist fast so schlecht wie gar keine Aussage. Nenne immer Quelle, Jahr und Kernaussage.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Ein Guide von 2023 ohne Update wird von KI-Systemen zugunsten aktuellerer Quellen übergangen. Besonders kritisch bei schnelllebigen Themen wie KI und Technologie. Zeige das Aktualisierungsdatum und halte Inhalte aktuell.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Ein 3.000-Wörter-Fließtext ohne Zwischenüberschriften, Listen oder Tabellen ist für KI ein einziger Textblock. LLMs können daraus schwer einzelne Antworten extrahieren. Strukturiere mit H2/H3, nutze Listen für Aufzählungen und Tabellen für Vergleiche.
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Wenn dein Artikel das gleiche sagt wie 50 andere, hat KI keinen Grund, dich zu zitieren. Eigene Daten, eigene Frameworks, eigene Erfahrungen - das macht Content einzigartig und zitierbar. Frag dich: "Was weiß ich, das die anderen nicht wissen?"
              </p>
            </div>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl p-6">
              ...
              <p className="text-gray-600 leading-relaxed">
                Strukturierte Daten (Article, FAQ, HowTo) helfen KI-Systemen, deinen Content korrekt einzuordnen. Ohne Schema-Markup verlässt du dich darauf, dass KI die Struktur selbst erkennt - das funktioniert oft, aber nicht zuverlässig.
              </p>
            </div>
          </div>
      </section>
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20 max-w-[900px] mx-auto border-t border-gray-100">
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            <ul className="space-y-3 text-gray-600 text-sm leading-relaxed">
              <li>
                <strong className="text-black">Princeton University (2024):</strong> "GEO: Generative Engine Optimization" - Studie zur Optimierung von Inhalten für KI-Suchmaschinen. Zeigt, dass strukturierte Inhalte mit Quellenverweisen 115% mehr Zitierungen erhalten.
              </li>
              <li>
              ...
              <li>
                <strong className="text-black">HubSpot (2025):</strong> "State of Content Marketing Report" - Analyse von Content-Formaten und deren Performance in KI-gestützten Suchumgebungen.
              </li>
              <li>
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20 max-w-[900px] mx-auto border-t border-gray-100">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            ...
            >
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Wie du dein Unternehmen für ChatGPT, Claude und andere LLMs optimierst.
              </p>
            </a>
            ...
            >
              ...
              <p className="text-gray-600 text-sm leading-relaxed">
                Optimierung für Antwortmaschinen: Perplexity, Google AI und Co.
              </p>
            </a>
      ...
      <section className="py-20 md:py-28 px-6 md:px-12 lg:px-20 max-w-[900px] mx-auto border-t border-gray-100">
            ...
            <p className="text-lg text-gray-400 leading-relaxed mb-8 max-w-xl mx-auto">
              Finde heraus, wie KI-Systeme deinen Content aktuell bewerten - und was du ändern musst, um als Quelle zitiert zu werden.
            </p>
